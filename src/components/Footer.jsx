        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-400 hover:text-white">{t('footer.home')}</Link></li>
              <li><Link to="/marketplace" className="text-gray-400 hover:text-white">{t('footer.marketplace')}</Link></li>
